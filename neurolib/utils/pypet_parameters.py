import h5py
from pypet import Environment, Parameter, cartesian_product
...
def add_parameters(traj, params):
    ...
    traj.globalNetwork.density = Parameter("density", params["density"], comment="density of SC: cutoff weakest links, from 1 to 0")
    traj.globalNetwork.global_delay = Parameter("global_delay", params["global_delay"], comment="use global interareal delays, 1 or 0")

...
def get_params():
    ...
    params["net_record_example_v_traces"] = 0.0  # 100 #number of v_traces that are recorded, if no trace should be computed: 0
    ...
    params["color"] = {"net": "b", "fp": "0.6", "ln_exp": "darkmagenta", "ln_dos": "cyan", "ln_bexdos": "green", "spec1": "darkgreen", "spec2_red": "pink", "spec2": "orangered"}
    params["lw"] = {"net": "1", "fp": "2", "ln_exp": "1", "ln_dos": "2", "ln_bexdos": "2", "spec1": "1", "spec2_red": "1", "spec2": "1"}
    return params

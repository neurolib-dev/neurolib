...
class ALNModel:
    """
    Multi-population mean-field model with exciatory and inhibitory neurons per
    population.
    """
    ...
    def __init__(
        ...
        :param lookupTableFileName: Filename for precomputed transfer functions
            and tables
        :param seed: Random number generator seed
        :param simulateChunkwise: Chunkwise time integration (for lower memory
            use)
        ...
        self.lookupTableFileName = (
            lookupTableFileName
        )  # Filename for aLN lookup functions
        ...
        if simulateBOLD:
            self.simulateChunkwise = (
                True
            )  # Override this setting if BOLD is simulated!
        # Size of integration chunks in chunkwise integration in case of
        # simulateBOLD == True
        self.chunkSize = chunkSize
        # Save data of all chunks? Can be very memory demanding if simulations
        # are long or large
        self.saveAllActivity = False
